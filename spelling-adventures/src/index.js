...
import WORD_SETS from "./components/data/word-list.json"
...
root.render(<App wordsData={WORDS_DATA} accountsData={SAMPLE_ACCOUNTS} tagsData={TAGS_DATA} wordSets={WORD_SETS}/>);